...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/(propriete)/hide-child': RouteRecordInfo<'/(propriete)/hide-child', '/hide-child', Record<never, never>, Record<never, never>>,
    '/(propriete)/hide-child/one': RouteRecordInfo<'/(propriete)/hide-child/one', '/hide-child/one', Record<never, never>, Record<never, never>>,
    '/(propriete)/hide-child/three': RouteRecordInfo<'/(propriete)/hide-child/three', '/hide-child/three', Record<never, never>, Record<never, never>>,
    '/(propriete)/hide-child/two': RouteRecordInfo<'/(propriete)/hide-child/two', '/hide-child/two', Record<never, never>, Record<never, never>>,
